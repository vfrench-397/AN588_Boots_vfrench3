---
title: "vfrench3_PeerCommentary_martah"
author: "Marta"
date: "11/17/2021"
...
Victoria and I meet up in Zoom to go over the hw together. I think her code is great, the major things we talked about was se() and CIs. In her work she was using the quantile function which we agreed might be less helpful than running full upper and lower CIs for each value. We also were confused about the difference bewteen the SE and SD values between the model and the sample data, in the end I asked around and I *think* the difference is intentional? I'm still confused why it is exactly half but I think that comes from including na's (btw Victoria you're right, lm automatically omits na's of the two values you're graphing, but for other functions like CI or quantile you would need to go in and individually remove NA's in your variables). Other than that, Victoria had great work! Thank you for your help with the coef() function, a life saver!! 
...
retur <- return[, c(5,6,7,8,9,10,1,2,3,4)]
return
}
```
...
1. The bootstrapping estimates. Intially I was sampling the x and the y variable separately which was giving me estimates completely different from the model estimates. They still aren't perfectly aligned with the model estimates but they are much closer. 
